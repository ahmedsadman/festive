...
class Mailer:
    ...
    def send_participation_mail(self, email, event, identifier):
        html_content = '''
        Hello,<br>
        Thank you for participating in {event_name}. Your identifier is: <strong>{identifier}</strong>. 
        This will be required to verify your payment. Please don't share the identifier with anyone.<br>
        Please proceed to <a href="https://www.google.com">payment</a> to confirm
        your participation.<br>
        Looking forward to see you at the event.<br><br>
        <em>Regards,<br>
        IT Team, ICT Fest 2020<br></em>
        '''.format(event_name=event.name, identifier=identifier)
    ...
    def send_payment_confirmation(self, team):
        html_content = '''
        Hello,
        This to confirm you that we have received your payment for the identifier
        <strong>{}</strong>.<br>
        Looking forward to see you at the event.<br><br>
        <em>Regards,<br>
        IT Team, ICT Fest 2020<br></em>
        '''.format(team.team_identifier)
        self._set_subject('Payment confirmation for {}'.format(team.event.name))
